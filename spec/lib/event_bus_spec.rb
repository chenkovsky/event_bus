...
describe EventBus do
  ...
  xdescribe 'a temporary subscriber' do
  ...
  describe 'publishing' do
    ...
    xit 'accepts a string for the event name' do
    ...
    xit 'accepts a symbol for the event name' do
      expect(listener).to receive(:handler).with(event_name: :aa123bb)
      EventBus.subscribe(/aa123bb/, listener, :handler)
      EventBus.publish(:aa123bb)
    end
  ...
  describe 'subscribing' do
    ...
    xcontext 'with a regex pattern' do
    ...
    xcontext 'with a listener object' do
